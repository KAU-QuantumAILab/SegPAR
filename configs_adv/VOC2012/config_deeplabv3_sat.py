...
config = {
    ...
    "base_dir": "results/VOC2012/deeplabv3_sat",  # Base directory for saving results
    ...
    "limit": 2e-2,                                  # Convergence criterion
    ...
    ######### adv model setting #########
    "model": "deeplabv3_sat",
    "model_path": "adv_models/pretrain/voc2012/deeplabv3/sat/train_epoch_50.pth",
    "layers": 50,
    "zoom_factor": 8,
    "scales": [1.0],
    "base_size": 512,
