...
config = {
    ...
    "base_dir": "results/cityscapes/deeplabv3_sat",  # Base directory for saving results
    ...
    ######### adv model setting #########
    "model": "deeplabv3_sat",
    "model_path": "adv_models/pretrain/cityscapes/deeplabv3/sat/train_epoch_400.pth",
    "layers": 50,
    "zoom_factor": 8,
    "scales": [1.0],
    "base_size": 1024,
